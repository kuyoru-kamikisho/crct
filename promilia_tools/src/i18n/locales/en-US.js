export default {
  ...
  rank: {
    ...
    showAll: 'Show all',
    showTop: 'Show top',
    hexagonTab: 'Hexagon Stats',
    hexagonHint: 'Who is the true hexagonal warrior?',
    hexagonLead: 'All six polls combined into a radar chart — the closer to a hexagon, the more complete.',
    hexagonTotal: 'Hex total',
    hexagonRank: 'Rank #$rp',
    radarShort: {
      favorite: 'Fav',
      output: 'DPS',
