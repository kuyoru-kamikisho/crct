export default {
  ...
  nav: {
    ...
    mapTool: 'World Map',
    characterRank: 'Character Rankings',
  },
  header: {
    language: 'Language',
    theme: 'Theme',
  ...
  seo: {
    ...
    homeTitle: 'Azur Promilia Wiki | Characters, Qibo, Items & Tools',
    homeDescription:
      'Unofficial Azur Promilia wiki with character skills, Qibo codex, item sources, guides, and community tools. Data is based on public beta information.',
    homeKeywords: 'Azur Promilia,wiki,character codex,Qibo,items,Manjuu',
    ...
    itemsTitle: 'Item Codex | Azur Promilia Wiki',
    itemsDescription: 'Azur Promilia item codex: shops, home crafting, gathering, fishing, and other sources.',
    itemsKeywords: 'Azur Promilia items,codex,shops,cooking,gathering',
    itemSourceTitle: '$rp | Item Codex | Azur Promilia Wiki',
    itemSourceDescription: 'Items obtainable from $rp in Azur Promilia, including rarity and effects.',
    itemSourceKeywords: '$rp,Azur Promilia items,codex',
    itemDetailTitle: '$rp | $rp-Star | Azur Promilia Item',
    itemDetailDescription: '$rp is a $rp-star item in Azur Promilia. $rp',
    itemDetailKeywords: '$rp,Azur Promilia $rp,item codex',
    itemImageAlt: '$rp icon from Azur Promilia',
    ...
    rankTitle: 'Character Rankings | Azur Promilia Wiki',
    rankDescription:
      'Vote for your favorite Azur Promilia characters and rate output, shield break, healing, support, and more. View totals and daily or monthly trends.',
    rankKeywords: 'Azur Promilia character ranking, character vote, favorite character',
  ...
  item: {
    title: 'Item Codex',
    summary: 'There are $rp items in total.',
    sourceSummary: '$rp includes $rp items.',
    catalogHint: 'Filter by rarity, type, and source. Items without a listed source are kept here.',
    wiki: 'BWiki entry',
    desc: 'Description',
    spdesc: 'Lore',
    effects: 'Effects',
  ...
  rank: {
    ...
    hint: 'Give your favorite characters a vote~',
    rulesTitle: 'Voting rules',
    ruleDaily: 'You can submit once per category each day, and pick up to 5 characters.',
    ruleDevice:
      'There is no account system. Votes are tied to a browser token and device fingerprint. The same device can vote once per day; clearing cache may still be recognized as the same device.',
    ruleLan: 'Different devices on the same public IP (office or campus NAT) can vote separately.',
    ruleIndependent: 'Favorite-character votes and each ability poll are counted separately.',
    selected: 'Selected $rp / $rp',
    confirm: 'Confirm vote',
    confirmTitle: 'Submit this vote?',
    confirmBody: 'These characters will receive your vote. You cannot change it today.',
    confirmOk: 'Submit',
    confirmCancel: 'Not yet',
    voted: 'You already voted in this category today',
    voteSuccess: 'Vote submitted. Thank you!',
    voteFail: 'Vote failed. Please try again later.',
    alreadyVoted: 'You already voted today. Come back tomorrow.',
    tooMany: 'You can pick up to 5 characters',
    emptySelect: 'Please pick at least one character',
    rankingTitle: 'Total votes',
    trendTitle: 'Daily / monthly vote trends',
    trendDaily: 'Daily',
    trendMonthly: 'Monthly',
    fullscreen: 'Fullscreen',
    exitFullscreen: 'Exit fullscreen',
    zoomHint: 'Scroll or drag to zoom and pan the timeline',
    scrollHint: 'Scroll to see every character',
    votes: 'Total votes',
    dailyVotes: 'Votes that day',
    monthlyVotes: 'Votes that month',
    loading: 'Loading vote data…',
    offline: 'The vote service is unavailable. Start the Python server and refresh.',
    noVotes: 'No votes yet — be the first!',
    showSeries: 'Characters on chart',
    showAll: 'Show all',
    showTop: 'Show top',
    categories: {
      favorite: 'Favorite',
    ...
    errors: {
      ...
      DEVICE_ALREADY_VOTED: 'This device already voted today.',
      TOO_MANY: 'You can pick up to 5 characters',
      EMPTY: 'Please pick at least one character',
      UNKNOWN_CHARACTER: 'A selected character is not on the current roster',
      RATE_LIMITED: 'Too many requests. Please wait a moment.',
      OFFLINE: 'The vote service is unavailable. Start the server and refresh.',
    },
  },
}
